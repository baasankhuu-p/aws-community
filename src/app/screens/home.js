...
function About() {
  return (
    <div id="home" className="relative h-full min-h-screen flex flex-col justify-center md:flex-row md:justify-around items-center z-0 bg-black">
      {/* bg-defbggray */}
      <Image
      ...
      <Image className="z-10 lg hidden md:flex mx-auto" src={aws_ub} />
    </div>
  );
}
