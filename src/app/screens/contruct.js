    ...
    <div className="flex flex-col justify-center items-center">
      <div className="md:w-2/3 p-10 my-24 lg:my-10 shadow-xl shadow-slate-700 contruct">
        ...
        <div style={{fontSize:'16px', lineHeight:'25px'}}>
          ...
          Ulaanbaatar 2023 are required to agree with the following code of
          conduct. Organizers will enforce this code throughout the event. We
          are expecting cooperation from all participants to help ensure a safe
          environment for everybody.<br/><br/> <p>The Quick Version</p> Our conference is
          ...
          language and imagery are not appropriate for any conference venue,
          ...
          conference organizers. <br/><br/><p>The Less Quick Version</p> Harassment includes
          offensive verbal comments related to gender, gender identity and
          expression, age, sexual orientation, disability, physical appearance,
          body size, race, ethnicity, religion, technology choices, sexual
          ...
          expected to comply immediately. <br/><br/>Sponsors are also subject to the
          anti-harassment policy. In particular, sponsors should not use
          sexualized images, activities, or other material. Booth staff
          (including volunteers) should not use sexualized
          clothing/uniforms/costumes or otherwise create a sexualized
          environment. <br/><br/>If a participant engages in harassing behavior, the
          ...
          no refund. <br/><br/>If you are being harassed, notice that someone else is
          being harassed, or have any other concerns, please contact a member of
          conference staff immediately. <br/><br/>Conference staff can be identified by
          distinct staff badges. Conference staff will be happy to help
          ...
          attendance. <br/><br/>We expect participants to follow these rules at conference
          and workshop venues and conference-related social events. <br/><br/>AWS
          Community Day Ulaanbaatar 2023 Code of Conduct is based on
